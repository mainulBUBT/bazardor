...
<div class="settings-nav">
    ...
    <a href="{{ route('admin.settings.index', ['tab' => LANGUAGE_SETTINGS]) }}" class="settings-nav-item {{ request()->query('tab') == LANGUAGE_SETTINGS ? 'active' : '' }}" data-target="{{ LANGUAGE_SETTINGS }}">
        <i class="fas fa-language mr-1"></i> {{ translate('messages.Languages') }}
    </a>
