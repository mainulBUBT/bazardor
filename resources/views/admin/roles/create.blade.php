...
@section('title', translate('messages.Create Role'))

@section('content')
<!-- Page Heading -->
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">{{ translate('messages.Create New Role') }}</h1>
    ...
    <div class="row">
        <div class="col-lg-12 d-flex justify-content-end mb-4">
            ...
            <button type="submit" class="btn btn-primary">
                <i class="fas fa-save"></i> {{ translate('messages.Create Role') }}
            </button>
        </div>
    </div>
</form>
