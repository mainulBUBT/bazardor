                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-2">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input permission-checkbox" name="permissions[]" value="{{ $actions['manage']->id }}" id="permission-{{ $actions['manage']->id }}" 
                                        {{ (is_array(old('permissions')) && in_array($actions['manage']->id, old('permissions'))) || 
                                           (empty(old('permissions')) && in_array($actions['manage']->id, $rolePermissions)) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-3 mb-2">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input permission-checkbox" name="permissions[]" value="{{ $actions['create']->id }}" id="permission-{{ $actions['create']->id }}" 
                                        {{ (is_array(old('permissions')) && in_array($actions['create']->id, old('permissions'))) || 
                                           (empty(old('permissions')) && in_array($actions['create']->id, $rolePermissions)) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-3 mb-2">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input permission-checkbox" name="permissions[]" value="{{ $actions['view']->id }}" id="permission-{{ $actions['view']->id }}" 
                                        {{ (is_array(old('permissions')) && in_array($actions['view']->id, old('permissions'))) || 
                                           (empty(old('permissions')) && in_array($actions['view']->id, $rolePermissions)) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-3 mb-2">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input permission-checkbox" name="permissions[]" value="{{ $actions['edit']->id }}" id="permission-{{ $actions['edit']->id }}" 
                                        {{ (is_array(old('permissions')) && in_array($actions['edit']->id, old('permissions'))) || 
                                           (empty(old('permissions')) && in_array($actions['edit']->id, $rolePermissions)) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-3 mb-2">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input permission-checkbox" name="permissions[]" value="{{ $actions['delete']->id }}" id="permission-{{ $actions['delete']->id }}" 
                                        {{ (is_array(old('permissions')) && in_array($actions['delete']->id, old('permissions'))) || 
                                           (empty(old('permissions')) && in_array($actions['delete']->id, $rolePermissions)) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-3 mb-2">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input permission-checkbox" name="permissions[]" value="{{ $actions['approve']->id }}" id="permission-{{ $actions['approve']->id }}" 
                                        {{ (is_array(old('permissions')) && in_array($actions['approve']->id, old('permissions'))) || 
                                           (empty(old('permissions')) && in_array($actions['approve']->id, $rolePermissions)) ? 'checked' : '' }}>
                                ...
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input permission-checkbox" name="permissions[]" value="{{ $permission->id }}" id="permission-{{ $permission->id }}" 
                                        {{ (is_array(old('permissions')) && in_array($permission->id, old('permissions'))) || 
                                           (empty(old('permissions')) && in_array($permission->id, $rolePermissions)) ? 'checked' : '' }}>
...
<script>
    $(document).ready(function() {
        ...
        // Function to update group checkboxes based on selected permissions
        function updateGroupCheckboxes() {
            $('.card').each(function() {
                const totalPermissions = $(this).find('.permission-checkbox').length;
                const checkedPermissions = $(this).find('.permission-checkbox:checked').length;
                
                if (totalPermissions > 0 && totalPermissions === checkedPermissions) {
                    $(this).find('.group-select').prop('checked', true);
                }
            });
        }
