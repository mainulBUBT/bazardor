...
<head>
    ...
    <meta name="description" content="Admin login for Bazar-dor">
    <meta name="author" content="">
    <meta name="csrf-token" content="{{ csrf_token() }}">

    <title>Bazar-dor Admin - Login</title>
    ...
    <!-- Custom styles for scrollable sidebar -->
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Welcome to Bazar-dor Admin</h1>
                                    </div>
                                    <form class="user" method="POST" action="{{ route('admin.auth.login.submit') }}">
                                        @csrf
