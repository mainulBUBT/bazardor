...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{url('/admin')}}">
        ...
        <div class="sidebar-brand-text mx-3">BazarDor Admin</div>
    </a>
    ...
    <li class="nav-item {{ request()->is('admin/categories*') ? 'active' : '' }}">
        ...
        <div id="collapseCategories" class="collapse" aria-labelledby="headingCategories" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="{{url('/admin/categories')}}">All Categories</a>
                <a class="collapse-item" href="{{url('/admin/categories/create')}}">Add Category</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item {{ request()->is('admin/markets*') ? 'active' : '' }}">
        ...
        <div id="collapseMarkets" class="collapse" aria-labelledby="headingMarkets" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="{{url('/admin/markets')}}">All Markets</a>
                <a class="collapse-item" href="{{url('/admin/markets/create')}}">Add Market</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item {{ request()->is('admin/points*') ? 'active' : '' }}">
        ...
        <div id="collapsePoints" class="collapse" aria-labelledby="headingPoints" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="{{url('/admin/points/manage')}}">Manage Points</a>
                <a class="collapse-item" href="{{url('/admin/points/redemptions')}}">Redemptions</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item {{ request()->is('admin/notifications*') ? 'active' : '' }}">
        ...
        <div id="collapsePushNotifications" class="collapse" aria-labelledby="headingPushNotifications" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="{{url('/admin/notifications')}}">All Notifications</a>
                <a class="collapse-item" href="{{url('/admin/notifications/create')}}">Send Notification</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item {{ request()->is('admin/banners*') ? 'active' : '' }}">
        ...
        <div id="collapseBanners" class="collapse" aria-labelledby="headingBanners" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="{{url('/admin/banners')}}">All Banners</a>
                <a class="collapse-item" href="{{url('/admin/banners/create')}}">Add Banner</a>
            </div>
        </div>
    </li>
